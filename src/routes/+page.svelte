...
<section class="text-center max-w-5xl mx-auto">
  ...
  <p class="mt-2">
    ...
    place for you. The files might be useful for testing upload, HTML5 videos etc. All files are
...
<section class="text-center max-w-5xl mx-auto py-10">
  ...
  <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
    <div class="card bg-base-100 shadow-md">
      <div class="card-body">
        ...
        <div class="card-actions justify-center mt-2">
          <a href="https://onlinemarkdown.com/" class="btn text-lg w-full">Visit Online Markdown Editor</a>
        </div>
      </div>
    </div>
    <div class="card bg-base-100 shadow-md">
      <div class="card-body">
        ...
        <div class="card-actions justify-center mt-2">
          <a href="https://notepadplus.org/" class="btn text-lg w-full">Visit Notepad Plus</a>
        </div>
      </div>
    </div>
  </div>
