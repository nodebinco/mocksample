...
<ul>
	...
	<li>
		<p>
			...
			in this Agreement) refers to MockSample.
		</p>
	</li>
	<li>
		<p>
	...
	<li>
		<p>
			...
			refers to MockSample, accessible from
			<a href="/">https://mocksample.com</a>
		</p>
	</li>
	<li>
		<p>
...
<ul>
	...
	<li>
		<p>
			...
			with news, special offers and general information about other goods, services and events which
			we offer that are similar to those that you have already purchased or enquired about unless You
...
<ul>
	...
	<li>
		...
		to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint
...
<ul>
	<li>By email: info@mocksample.com</li>
</ul>
